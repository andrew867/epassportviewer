...
"""
    ...
    HELP, APP, TICK, ERROR, TRANSPARENT, LOGO, NEWGSI, GPLV3 = ('help','app','tick','error','transparent', 'logo', 'newgsi', 'gplv3')
    TYPES = [HELP, APP, TICK, ERROR, TRANSPARENT, LOGO, NEWGSI, GPLV3]
